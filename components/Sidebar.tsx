...
const DesktopSidebar = () => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-normal gap-2 border-b-[1px] border-separate p-4">
        <Logo />
      </div>
...
export function MobileSidebar() {
  ...
  return (
    <div className="block border border-separate bg-background md:hidden">
